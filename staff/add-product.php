        ...
        <div class="card" id="card-whole-add-product">
            ...
            <div class="card-body">
                <div id="card-input-add-product">
                        <form name="form_menu_detail" method="POST" onsubmit="return alert('Details are updated successfully');" 
                ...
                <div id="card-input-add-product">
                    <form name="form-add-product" method="POST">
                        ...
                        <div class="form-group">       
                            ...
                            <input type="text" class="form-control" id="ID" style="width:80%" name="dish_id" placeholder="A001">
                        </div>
