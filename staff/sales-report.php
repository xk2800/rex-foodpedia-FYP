...
<div class="main-page">
    <div class="container">
        <p id="navbar-view-by-report"><span style="color:red;">* </span>Please select a duration : </p>
    </div>
            ...
            <div class="card-body">
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active " id="pills-daily" role="tabpanel" aria-labelledby="pills-daily-tab">
                        ...
                        <h5 class="card-subtitle mb-2 text-muted" id="daily-rev" style="padding-bottom:10px;">Total Revenue - Today</h5>
                    ...
                    <div class="tab-pane fade" id="pills-weekly" role="tabpanel" aria-labelledby="pills-weekly-tab">
                        ...
                        <h5 class="card-subtitle mb-2 text-muted" id="weekly-rev" style="padding-bottom:10px;">Total Revenue - Within last week </h5>
                        <h6 class="card-subtitle mb-2 text-muted" id="date-sales-week-report" >
                            <script>
                                var date_b = new Date();
                                var date_before = new Date(Date.now() - 7 * 24 * 60 * 60 * 1000)
                                var months = ["January","February","March","April","May","June","July","August","September","October","November","December"];
                                document.getElementById("date-sales-week-report").innerHTML = date_before.getDate() + " " + months[date_b.getMonth() - 1] + " - " + " " + date_b.getDate() + " " + months[date_b.getMonth()];
                            </script>
                        </h6>
                        <br/>
                        <hr/>
                    ...
                    <div class="tab-pane fade show" id="pills-monthly" role="tabpanel" aria-labelledby="pills-monthly-tab">
                        ...
                        <h5 class="card-subtitle mb-2 text-muted" id="monthly-rev" style="padding-bottom:10px;">Total Revenue - This Month</h5>
                        <h6 class="card-subtitle mb-2 text-muted" id="date-sales-monthly-report" >
                            <script>
                                    var date_c = new Date();
                                    var months = ["January","February","March","April","May","June","July","August","September","October","November","December"];
                                    document.getElementById("date-sales-monthly-report").innerHTML = months[date_c.getMonth()] + " " + "2021";
                            </script>  
                        </h6>
                        <br/>
                        <hr/>
